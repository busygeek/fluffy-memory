...
public class RequestConfig {
    ...
    // NEW FIELD for v11
    private String operationDetectionCondition;
}
...
public class EnhancedDynamicRouteService {
    ...
    public ValidationResult validateRequest(RouteConfig route, Map<String, Object> requestBody, 
        ...
        if (reqConfig.getOperationDetectionCondition() != null) {
            isUpdateOperation = evaluateCondition(reqConfig.getOperationDetectionCondition(), 
        ...
        // Validate using applicable rules
        if (requestBody != null) {
        ...
        // Validate required body parameters (existing logic)
...
/*
{
  ...
  "requestConfig": {
    ...
    "operationDetectionCondition": "body_has_field:guid",
    "fieldRules": [
      {
